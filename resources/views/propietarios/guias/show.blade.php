                    ...
                    <div class="card-body">
                        <form action="{{ route('proguias.update', $guia->id) }}" class="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex flex-column align-items-center text-center">
                                @if($guia->file)
                                    <img src="{{ asset('panelguias/'.$guia->file) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="200">
                                @else
                                    <img src="{{ asset('assets/imagenes/img_default.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="200">
                                @endif

                                <div class="mt-3">
                                    <h5 class="title_dir">{{ $guia->nombre }}</h5>
                                    <p class="text-secondary mb-1">{{ $guia->apellido }}</p>
                        ...
                        <form action="{{ route('proguias.update', $guia->id) }}" class="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 pt-3 pb-2 col-md-12">
                                ...
                                <div class="form-group mb-2 mt-2 col-md-6">
                                    ...
                                    <input class="form-control form-control-solid" id="cuenta" name="cuenta" type="number" required value="{{ $guia->cuenta }}" />
                                </div>
