                    ...
                    <div class="card-body">
                        <form action="{{ route('prococineros.update', $cocinero->id) }}" class="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex flex-column align-items-center text-center">
                                @if($cocinero->file)
                                    <img src="{{ asset('panelcocineros/'.$cocinero->file) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="200">
                                @else
                                    <img src="{{ asset('assets/imagenes/img_default.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="200">
                                @endif

                                <div class="mt-3">
                                    <h5 class="title_dir">{{ $cocinero->nombre }}</h5>
                                    <p class="text-secondary mb-1">{{ $cocinero->apellido }}</p>
