    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary pt-3 py-4 pb-3">
                <h6 class="modal-title text-white">Crear nueva empresa</h6>
            ...
            <div class="modal-body bg-white p-4">
                <div class="row g-3 pt-3 pb-2 col-md-12">
                    ...
                    <div class="form-group mb-2 mt-2 col-md-6">
                        ...
                        <input class="form-control form-control-solid" id="telefono" name="telefono" type="text" required />
                    </div>
                    ...
                    <div class="form-group mb-2 mt-2 col-md-6">
                        ...
                        <input class="form-control form-control-solid" id="web" name="web" type="text" required />
                    </div>

                    <div class="form-group mb-2 mt-2 col-md-6">
                        <label class="mb-2">Número de NIT</label>
                        <input class="form-control form-control-solid" id="nit" name="nit" type="text" required />
                    </div>
