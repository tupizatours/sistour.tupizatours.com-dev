...
@section('content')
    @if ($message = Session::get('success'))
        <div class="alert alert-success border-0 bg-success alert-dismissible fade show py-2">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    <h6 class="mb-0 text-white font-14">Despacho - {{ $message }}</h6>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-header bg-primary pt-3 pb-3">
            <div class="d-flex align-items-center">
                <div>
                    <h6 class="mb-0 title_page text-white">LISTADO DE GESTIONES</h6>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="{{ URL::to('despachos/gestiones/' . $reserva->id) }}" class="ms-1">
