    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary pt-3 py-4 pb-3">
                <h6 class="modal-title text-white">Crear nueva vagoneta</h6>
            ...
            <div class="modal-body bg-white p-4">
                <div class="row g-3 pt-3 pb-2 col-md-12">
                    ...
                    <div class="form-group mb-2 mt-2 col-md-6">
                        ...
                        <input class="form-control form-control-solid" id="marca" name="marca" type="text" />
                    </div>

                    <div class="form-group mb-2 mt-2 col-md-6">
                        <label class="mb-2">Placa</label>
                        <input class="form-control form-control-solid" id="placa" name="placa" type="text" />
                    </div>

                    <div class="form-group mb-2 mt-2 col-md-6">
                        <label class="mb-2">Color</label>
                        <input class="form-control form-control-solid" id="color" name="color" type="text" />
                    </div>

                    <div class="form-group mb-2 mt-2 col-md-6">
                        <label class="mb-2">Modelo</label>
                        <input class="form-control form-control-solid" id="modelo" name="modelo" type="text" />
                    </div>
