<div class="modal fade ModalPreDelete" id="ModalRestaurar{{ $turista->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-transparent pt-3 py-4 pb-3">
                <h6 class="modal-title">Restaurar servicio de turista</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <div class="modal-body bg-white pt-2 pb-2 p-4">
                ¿Estas seguro que deseas restaurar este registro?
            </div>
