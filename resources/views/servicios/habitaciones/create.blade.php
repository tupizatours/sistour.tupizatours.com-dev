    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary pt-3 py-4 pb-3">
                <h6 class="modal-title text-white">Crear nueva habitación</h6>
            ...
            <div class="modal-body bg-white p-4">
                <div class="row g-3 pt-3 pb-2 col-md-12">
                    ...
                    <div class="form-group mb-2 mt-2 col-md-6">
                        ...
                        <input class="form-control form-control-solid" id="costo" name="costo" type="number" required />
                    </div>

                    <div class="form-group mb-2 mt-2 col-md-6">
                        <label class="mb-2">Precio de costo extranjeros</label>
                        <input class="form-control form-control-solid" id="cos_ext" name="cos_ext" type="number" required />
                    </div>

                    <div class="form-group mb-2 mt-2 col-md-6">
                        <label class="mb-2">Precio nacionales</label>
                        <input class="form-control form-control-solid" id="nacionales" name="nacionales" type="number" required />
                    </div>

                    <div class="form-group mb-2 mt-2 col-md-6">
                        <label class="mb-2">Precio extranjeros</label>
                        <input class="form-control form-control-solid" id="extranjeros" name="extranjeros" type="number" required />
                    </div>
