...
class TiendaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tienda.index', compact('links', 'onlines', 'qrs', 'habitaciones', 'alimentos', 'alergias', 'tours', 'countries', 'hottus', 'hoteles', 'categorias', 'servicios', 'tickets', 'turistas', 'accesorios'));
    }
    ...
    public function show($id)
    {
        ...
        return view('tienda.show', compact('links', 'onlines', 'qrs', 'habitaciones', 'alimentos', 'alergias', 'tour', 'countries', 'hoteles', 'servicios', 'tickets', 'turistas', 'accesorios'));
    }
